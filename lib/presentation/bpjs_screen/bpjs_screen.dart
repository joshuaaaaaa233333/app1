...
// ignore_for_file: must_be_immutable
class BpjsScreen extends StatelessWidget {TextEditingController group872Controller = TextEditingController();

GlobalKey<FormState> _formKey = GlobalKey<FormState>();

@override Widget build(BuildContext context) { return SafeArea(child: Scaffold(backgroundColor: ColorConstant.whiteA700, resizeToAvoidBottomInset: false, appBar: CustomAppBar(height: getVerticalSize(66), leadingWidth: 52, leading: AppbarImage(height: getSize(30), width: getSize(30), svgPath: ImageConstant.imgArrowleft, margin: getMargin(left: 22, top: 13, bottom: 12), onTap: () => onTapArrowleft108(context)), centerTitle: true, title: AppbarSubtitle1(text: "BPJS"), styleType: Style.bgFillWhiteA700), body: Form(key: _formKey, child: Container(width: double.maxFinite, child: Column(mainAxisAlignment: MainAxisAlignment.start, children: [CustomTextFormField(focusNode: FocusNode(), controller: group872Controller, hintText: "0001260955666", margin: getMargin(left: 25, top: 18, right: 25), textInputAction: TextInputAction.done, textInputType: TextInputType.phone), Spacer()]))), bottomNavigationBar: Container(padding: getPadding(left: 25, top: 11, right: 25, bottom: 11), decoration: BoxDecoration(image: DecorationImage(image: fs.Svg(ImageConstant.imgGroup962), fit: BoxFit.cover)), child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, children: [CustomButton(height: getVerticalSize(37), text: "Lanjut", margin: getMargin(bottom: 1), onTap: () => onTapLanjut(context))])))); } 
onTapLanjut(BuildContext context) { Navigator.pushNamed(context, AppRoutes.bpjsBayarOneScreen); } 
onTapArrowleft108(BuildContext context) { Navigator.pop(context); } 
 }
